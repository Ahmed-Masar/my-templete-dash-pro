...
const STATUS_CONFIG: Record<CartStatus, {
    ...
    draft: {
        ...
        icon: <Clock color="currentColor" size="12" />,
    ...
    generated: {
        ...
        icon: <FileCheck color="currentColor" size="12" />,
    ...
    completed: {
        ...
        icon: <CheckCircle2 color="currentColor" size="12" />,
    ...
    cancelled: {
        ...
        icon: <XCircle color="currentColor" size="12" />,
...
const STATUS_OPTIONS: { value: CartStatus; label: string; icon: React.ReactNode; color: string }[] = [
    { value: "draft", label: "Draft", icon: <Clock color="currentColor" size="16" className="text-slate-500" />, color: "text-slate-500" },
    { value: "generated", label: "Generated", icon: <FileCheck color="currentColor" size="16" className="text-blue-500" />, color: "text-blue-500" },
    { value: "completed", label: "Completed", icon: <CheckCircle2 color="currentColor" size="16" className="text-green-500" />, color: "text-green-500" },
    { value: "cancelled", label: "Cancelled", icon: <XCircle color="currentColor" size="16" className="text-red-500" />, color: "text-red-500" },
];
                                        ...
                                        <React.Fragment key={cart._id}>
                                            ...
                                            >
                                                <TableCell className="w-10 pr-0 pl-4">
                                                    <ChevronRight color="currentColor" size="16" className={cn(
                                                ...
                                                <TableCell className="text-center">
                                                    <div className="inline-flex items-center gap-1">
                                                        <Star color="currentColor" size="14" className="fill-amber-400 text-amber-400" />
                                                ...
                                                >
                                                    <div className="flex items-center justify-center gap-1">
                                                        ...
                                                        >
                                                            <FileText color="currentColor" size="14" />
                                                        </Button>
                                                        {cart.pdfUrl && (
                                                            <a href={cart.pdfUrl} target="_blank" rel="noopener noreferrer">
                                                                <Button variant="outline" size="sm" className="h-7 w-7 p-0 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300 transition-colors" title="Download PDF">
                                                                    <Download color="currentColor" size="14" />
                                                                </Button>
                                                            </a>
                                                        )}
                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className="space-y-2">
                                                                            {cart.totalPoints != null && (
                                                                                <div className="flex items-center justify-between text-sm">
                                                                                    <span className="flex items-center gap-1.5 text-muted-foreground">
                                                                                        <Star color="currentColor" size="12" className="fill-amber-400 text-amber-400" />
                                                                                        Customer pts
                                                                                    </span>
                                                                            ...
                                                                            {cart.totalVendorPoints != null && (
                                                                                <div className="flex items-center justify-between text-sm">
                                                                                    <span className="flex items-center gap-1.5 text-muted-foreground">
                                                                                        <Star color="currentColor" size="12" className="fill-purple-400 text-purple-400" />
                                                                                        Vendor pts
                                                                                    </span>
